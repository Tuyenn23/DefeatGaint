...
namespace FIMSpace.RagdollAnimatorDemo
{
    ...
    public class Demo_Ragd_PushAndGetUp : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0) && !GameManager.instance.WeaponController.IsHaveWeapon)
            {
                ...
                if (Physics.Raycast(r, out hit, Mathf.Infinity))
                {
                    if (hit.rigidbody)
                    {
                        ...
                        if(hit.rigidbody.gameObject.tag == "Body")
                        {
                            /*PrefabStorage.Instance.CurrentEnemy.TakeDamage(E_BodyPart.Others, 10);*/
                        }

                        if (hit.rigidbody.gameObject.tag == "Head")
                        {
                            /*PrefabStorage.Instance.CurrentEnemy.TakeDamage(E_BodyPart.Head, 10);*/
                        }
